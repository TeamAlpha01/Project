...
namespace UnitTesting.MockData
{
    ...
    {
        public static List<Drive> GetDriveMockNonCancelled()
        {
            List<Drive> mockDrives = new List<Drive>();
            mockDrives.Add(new Drive(){ DriveId = 1, Name = "Todays Drive 1", FromDate = System.DateTime.Now, ToDate = System.DateTime.Now,  DepartmentId = 1, PoolId = 1, ModeId = 2, LocationId = 1, AddedBy = 1, UpdatedBy = 1,IsCancelled=false,IsScheduled=true,Pool=new Pool(){PoolName="TestPool",department=new Department(){DepartmentName="testDepartment"}},Location=new Location(){LocationName="TestLocation"}});
            mockDrives.Add(new Drive(){ DriveId = 2, Name = "Todays Drive 2", FromDate = System.DateTime.Now, ToDate = System.DateTime.Now,  DepartmentId = 1, PoolId = 1, ModeId = 2, LocationId = 1, AddedBy = 1, UpdatedBy = 1 ,IsCancelled=false,IsScheduled=true,Pool=new Pool(){PoolName="TestPool",department=new Department(){DepartmentName="testDepartment"}},Location=new Location(){LocationName="TestLocation"}});
            mockDrives.Add(new Drive(){ DriveId = 3, Name = "Scheduled Drive 1", FromDate = System.DateTime.Now.AddDays(10), ToDate = System.DateTime.Now.AddDays(10),  DepartmentId = 1, PoolId = 1, ModeId = 2, LocationId = 1, AddedBy = 1, UpdatedBy = 1 ,IsCancelled=false,IsScheduled=true,Pool=new Pool(){PoolName="TestPool",department=new Department(){DepartmentName="testDepartment"}},Location=new Location(){LocationName="TestLocation"}});
            mockDrives.Add(new Drive(){ DriveId = 4, Name = "Scheduled Drive 2", FromDate = System.DateTime.Now.AddDays(10), ToDate = System.DateTime.Now.AddDays(10),  DepartmentId = 1, PoolId = 1, ModeId = 2, LocationId = 1, AddedBy = 1, UpdatedBy = 1 ,IsCancelled=false,IsScheduled=true,Pool=new Pool(){PoolName="TestPool",department=new Department(){DepartmentName="testDepartment"}},Location=new Location(){LocationName="TestLocation"}});
            mockDrives.Add(new Drive(){ DriveId = 5, Name = "Upcomming Drive 1", FromDate = System.DateTime.Now.AddDays(10), ToDate = System.DateTime.Now.AddDays(10),  DepartmentId = 1, PoolId = 1, ModeId = 2, LocationId = 1, AddedBy = 1, UpdatedBy = 1 ,IsCancelled=false,IsScheduled=false,Pool=new Pool(){PoolName="TestPool",department=new Department(){DepartmentName="testDepartment"}},Location=new Location(){LocationName="TestLocation"}});
            mockDrives.Add(new Drive(){ DriveId = 6, Name = "Upcomming Drive 2", FromDate = System.DateTime.Now.AddDays(10), ToDate = System.DateTime.Now.AddDays(10),  DepartmentId = 1, PoolId = 1, ModeId = 2, LocationId = 1, AddedBy = 1, UpdatedBy = 1 ,IsCancelled=false,IsScheduled=false,Pool=new Pool(){PoolName="TestPool",department=new Department(){DepartmentName="testDepartment"}},Location=new Location(){LocationName="TestLocation"}});
        ...
        public static List<object> GetTodaysDriveMock()
        {
        ...
        public static List<object> GetScheduledDriveMock()
        {
            List<object> mockDrives = new List<object>();
        ...
        public static List<object> GetUpcommingDriveMock()
        {
            List<object> mockDrives = new List<object>();
        ...
        public static List<object> GetCancelledDriveMock()
        {
            List<object> mockDrives = new List<object>();
